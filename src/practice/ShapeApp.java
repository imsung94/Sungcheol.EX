...
//		}
		 ...
		 * 
		 * 
		 * Shape s01 = new Rectangle("빨강", "빨강", 7, 7); Shape s02 = new Triangle("초록",
		 * "초록", 5, 5); Shape s03 = new Circle("노랑", "노랑", 10);
		 * 
		 * sArray[0] = s01; sArray[1] = s02; sArray[2] = s03;
		 * 
		 * for(int i=0; i<sArray.length; i++) { sArray[i].draw(); }
		 * 
		 * for(int i=0; i<sArray.length; i++) { if(sArray[i] instanceof Triangle ) {
		 * System.out.println(sArray[i].area()); } }
		 */
